...
//	private static final long serialVersionUID = 1L;
	...
	Start() {
		...
		menuBar = new JMenuBar();
			...
			mPomoc = new JMenu("Pomoc");
				...
				iExit = new JMenuItem("Wyjście"); iExit.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(cel==iAutor) JOptionPane.showMessageDialog(this, "Jarosław Bubicz", "Autor", JOptionPane.INFORMATION_MESSAGE); else
